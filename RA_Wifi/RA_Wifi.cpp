...
#ifdef SIXTEENCHPWMEXPANSION
#if defined(__SAM3X8E__)
				if (weboption2>=19 && weboption2<=35) ReefAngel.VariableControl.Set16ChannelOverride(weboption2-19,weboption);
#else
				if (weboption2>=19 && weboption2<=35) ReefAngel.PWM.Set16ChannelOverride(weboption2-19,weboption);
#endif
#endif // SIXTEENCHPWMEXPANSION
#endif // DisplayLEDPWM
				s = 9;  // <P>OK</P>
